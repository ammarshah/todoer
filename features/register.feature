Feature: Register
  ...
  Rule: Password length must be within 6 to 128 characters

    Example: User registers with a 5-character password
      Given I am on the registration page
      When I register with a 5-character password
      Then I should see an error message indicating that the password must be 6 to 128 characters long

    Example: User registers with a 6-character password
      Given I am on the registration page
      When I register with a 6-character password
      Then I should see a success message indicating that the account is successfully created
